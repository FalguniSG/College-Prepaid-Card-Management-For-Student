...
import { useUserRechargeHistory } from "@/hooks/recharge_history";
import { useEffect } from "react";

const RechargeHistory = () => {
  const { data, isLoading, mutate } = useUserRechargeHistory()
  ...
  return (
    <>
      <h1 className="pl-5 font-black">Recharge History</h1>
              ...
              {data?.data?.map((data, ind) => (
                ...
                <tr key={"rech" + ind}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                    ...
                    <p className="text-sm">{data?.created_at.split(" ")[1]}</p>
                  </td>
